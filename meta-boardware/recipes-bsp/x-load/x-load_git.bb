...
SRC_URI_append_beagleboard = " \
                             ...
                             "
SRC_URI_append_bw-b600 = " \
                              file://name.patch;patch=1 \
                             "
S = "${WORKDIR}/git"

PACKAGE_ARCH = "${MACHINE_ARCH}"
#XLOAD_MACHINE_bw-b600 = "omap3530beagle_config"
XLOAD_MACHINE_bw-b600 = "beagleboard_config"

COMPATIBLE_MACHINE = "(beagleboard|omap3evm|overo|bw-b600)"
